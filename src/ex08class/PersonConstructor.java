...
public class PersonConstructor {
	...
	public PersonConstructor(String name, int age) {
		...
		단, 생성자 내에서만 사용 가능하고 멤버메소드에서는 사용이 불가능하다. 
		 */
		this(name, age, "미상");
	...
	public PersonConstructor(String _name, int age, String addr) {
		//매개변수와 멤버변수 명이 다르면 this를 않아도 된다. 
		name = _name;
	...
	//멤버메소드  : 멤버변수를 초기화할 목적으로 정의한 메오드. 
	void initialize(String name, int age, String addr) {

		//해당 코드는 생성자 내에서만 사용할 수 있다. (this)
		//this(name, age, "미상");
		//멤버변수를 구분하기 위한 this는 사용할 수 없다. 
		this.name = name;
		this.age = age;
		this.addr = addr;
	}
