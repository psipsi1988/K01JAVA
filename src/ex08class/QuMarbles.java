...
# 어린이 객체를 생성시 구슬의 보유개수는 생성자를 통해 초기화 되어야 한다.
...
class ChildProperty{
	...
	/*
	디폴트 생성자는 개발자가 생성자를 정의하지 않을 때만 자동으로 생성된다. 
	 */
	//public ChildPropertyChildProperty() {}
	...
	public void obtainBead(ChildProperty child, int bCnt) {
		...
		//게임에 승리한 어린이는 해당 메소드를 호출하는 주체, 해당 객체가 된다. 
		this.beadCnt += bCnt;
