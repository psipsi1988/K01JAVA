...
오버로딩  : 함수명은 같으나 매개변수의 개수, 타입, 순서가 	다른 경우를 말한다. 
...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		/*
		참조변수에 상관 없이  항상 최하위에 오버라이딩된 메소드가 호출된다. 
		...
		ref2.loadMethod();
		ref2.loadMethod(1); //->클래스 영역까지 접근 가능
		//ref2.loadMethod(1.1); //접근 불가	
		
		//해당 객체를 A타입으로 간주하고 참조한다. 
		ref1.loadMethod(); //-> A클래스 영역까지 접근 가능
		//ref1.loadMethod(1); //접근 불가
		//ref1.loadMethod(1.1); //접근 불가
