...
/*
구성 관계로 표현하기에 적합한 Has-A관계
	X Has a Y -> X가 Y를 소유하고 있다.
	-경찰이 권총을 소유하다. 
	-경찰이 수갑을 소유하다. 
	
	 Has-A와 같이 소유의 관계를 상속으로 표현하면 클래스 간의 강한 연결고리가 
	 형성되어 권총이 없는 경찰을 표현하기가 힘들어진다. 
	 따라서 이 경우에는 구성 관계로 표현하는 것이 적합하다. 
	 구성 관계는 클래스의 멤버로 또 다른 객체를 정의하는 것을 말한다. 
 */
