...
형식]
	...
	※부모클래스를 상속받아 이름 없는 자식클래스를 생성하는 개념으로 이해하면 된다. 
...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		...
		: Person타입의 인스턴스 변수에 Person을 상속받은 
					익명클래스를 생성해서 그 주소를 할당한다. 
		...
		//Student클래스를 상속받아 정의한 익명클래스(즉, Student의 하위 익명 객체)
		...
		/*
		하위 익명클래스에서 확장한 변수이므로 익명객체를 통해서는 접근 불가. 
		 */
		
		//anonyStudent.age = 100 ; //접근 불가 - 에러 발생
		//((Student)anonyStudent).age = 100;//다운캐스팅 불가 - 에러 발생
		...
		/*
		Person anonyTest = new Student("다운캐스팅", "안 돼욤") {
			String jumin = "001024";
		};
		...
		*/
		...
		InterFace in = new InterFace() {
			...
			public void abstractMethod() {
				System.out.println("인터페이스의 추상메소드 모버라이딩");
