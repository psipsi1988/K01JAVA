...
/*
캡슐화(Encapsulation)
	(여러 가지 비즈니스 로직을 하나로 묶는다는 의미와 업무의 순서까지 
	고려한 형태의 로직을 구성한다는 의미를 가지고 있다. 
	즉, 관련 있는 메소드를 하나의 클래스로 묶는 것을 말한다. 
 */

//아래 네 가지 업무는 번호 순서대로 진행되어야 한다고 가정한다. 
class MemberRegist{
	void doMeberRegist() {
...
/*
업무의 순서고려하여 관련된 메소드를 하나의 클래스로 정의하였다. 
차후에는 별도의 분석 작업 없이 해당 클래스의 메소드만 호출하면 
업무는 오류 없이 진행될 것이다. 
 */
class EnapslLogic{
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		/*
		업무의 진행 순서가 중요하다고 했을 때 캡슐화 이전의 코드에서는 
