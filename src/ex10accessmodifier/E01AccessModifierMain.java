...
/*
접근지정자(접근제어지시자)
	: 클래스와 클래스 사이에 멤버 간의 접근을 제어하는 키워드를 말한다. 
...
접근지정자를 붙일 수 있는 곳
	...
	class 명 앞에는 public과 defalut만 붙일 수 있다. 
 */
...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		동일한 패키지에 선언된 클래스이므로 import 없이  객체 생성 및 접근이 가능하다. 
		 */
		...
		System.out.println("E01 AccessModifier2 객체 생성 및 접근");
