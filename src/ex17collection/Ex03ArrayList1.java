...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		List<E> 인터페이스 계열의 컬렉션
			: ArryList<T>와 같은 컬렉션은 제네릭 기반으로 하지만 
			아래와 같이 <T> 부분을 생략하면 모든 객체를 저장할 수 있는 컬렉션이 된다. 
			즉, <Object>로 선언한 것과 동일하다. 
		 */
		...
		list.add("트와이스");
		list.add(3, "워너원");
		//list.add(5, "소방차ㅋㅋ");//에러 발생. 인덱스는 건너뛸 수 없다. 
		...
		System.out.println(list.add("트와이스") ? "중복저장됨" : "중복저장 안 됨");
