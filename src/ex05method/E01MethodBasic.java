...
/*
메소드의 규칙
- Java에는 main메소드는 무조건 public static void로 선언하기로 약속되어 있다. 
...
public class E01MethodBasic {
	...
	/*
	메소드 정의 1 : 반환타입 0, 매개변수 0의 형태로 정의
	...
	public static void main(String[] args) {
		...
		매개변수가 있다면 개수만큼 포함시켜줘야 한다. 
		매개변수의 개수가 다르면 호출되지 않고 에러가 발생된다. 
		 */
