...
-자바에서 인스턴스의 내용 비교를 위해 비교연산자(==)를 사용하는 것은 
	단순히 참조 값에 대한 비교이므로 실제 내용에 대한 비교는 이뤄지지 않는다.
-인스턴스 간의 내용 비교를 위해서는 equals()메소드를 각 클래스에 
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		if(num1.myEquals(num2)) {
			...
			System.out.println("num1와 num2는 다른 정수");
		}
		...
		if(num1.myEquals(num3)) {
			...
			System.out.println("num1와 num3는 다른 정수");
		}
