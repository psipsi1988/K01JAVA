...
public class Ex02Priority {
	...
	public static void main(String[] args) {
		...
		/*
		1단계
			: 우선순위를 별도로 지정하지 않은 상태로 
			쓰레드를 생성하면 동일한 우선순위5를 부여받게 된다.
...
//		MessageSendingThread tr3 = new MessageSendingThread("세 번째");
		...
		MessageSendingThread tr1 = 
					new MessageSendingThread("첫 번째", Thread.MAX_PRIORITY);
		MessageSendingThread tr2 = 
					new MessageSendingThread("두 번째", Thread.NORM_PRIORITY);
		MessageSendingThread tr3 = 
					new MessageSendingThread("세 번째", Thread.MIN_PRIORITY);
		
		/*
		3단계
			: static상수 대신에 정수를 사용해도 무방하다. 
		 */
//		MessageSendingThread tr1 = new MessageSendingThread("첫 번째", 10);
//		MessageSendingThread tr2 = new MessageSendingThread("두 번째", 5);
//		MessageSendingThread tr3 = new MessageSendingThread("세 번째", 1);
