...
public class E03While {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] 1부터 100까지의 정수 중  3의 배수이거나 5의 배수인 수의 합을 
		...
		System.out.println("1~100사이 3 or 5의 배수합:" + total);
		...
		while(dan<=9) {//단은 2~9까지 증가함
			...
			while(su<=9) {//수 1~9까지 증가함
				//System.out.print(dan+"*"+su+*=*+(dan*su));//서식 차이, 줄이 안 맞음
