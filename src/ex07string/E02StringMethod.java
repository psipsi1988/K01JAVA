...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		2] charAt(인덱스) : 문자열에서 특정 index에 해당하는 
			문자 하나를 반환한다. index는 반드시 0부터 시작한다. 
		 */
		...
		/*
		시나리오] 해당 문자을이 이메일 형식인지 검사하는 
		목록을 작성하시오
		hong@ikosmo.co.k => 이메일 형식임
		...
		System.out.println("indexOf:"+
				str1.indexOf("a"));//12(앞에 있는 a의 인덱스)
		...
		13] split()
			...
			해당 구분자가 없는 경우에는 크기가 1인 String배열로 반환한다. 
		 */
		...
		String filename = "my.file.imges.jpg";
