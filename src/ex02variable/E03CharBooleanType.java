...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		/*
		cahr형 : 하나의 문자를 저장할 수 있는 자료형으로 값을 저장할 때 
			'(sing quotation)으로 감싸서 표현한다. 
			만약 "(double quotation)으로 감싸면 문자열로 인식하므로 
			String형으로 선언해야 한다. 
		 */
		char ch1 = '가';
		//char chStr = '가나다라';[에러발생] 문자열이므로 char형변수에  대입 불가
		String chStr = "가나다라";
		...
		아스키코드 : 1byte로 표현할 수 있는 문자(영문, 숫자)를 십진수코드로 
			...
			Ex) A => 65로 표현
			 	a => 97로 표현
		유니코드 : 1byte로 표현이 안 되는 문자(한글, 한자 등)는 2byte가 
		...
		/*
		boolean형 : true 혹은 false 두 가지의 값만 가질 수 있는 데이터형으로 
			산술 연산(+, -, *, /)이나 비교연산(<, >, = 등)은 사용이 불가능하다. 
			단, 논리연산은 가능하다. 
		 */
		boolean bn1 = true;
		boolean bn2 = false;
		...
		bn3 = '가' > 30000; // 가=> 유니코드 44032이므로 true 반환됨
