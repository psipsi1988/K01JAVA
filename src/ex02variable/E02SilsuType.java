...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		-정수형보다는 실수형이 더 큰 자료형이다. 
		 (0과 1 사이에 무수한 실수가 존재하기 때문)
		-따라서 long과 float의 연산결과는 flaot형이 된다.
		 */
		long long1 = 100;
		float float1 = 200;
		...
		/*
		float와 long의 연산 결과를 long으로 받고 싶다면 
		...
		-형 변환도 가능은 하지만 Java에서는 권장하지 않는다.
		 */
		float f3 = 100;
		
		
		//float f4 = 3.14; [에러발생]=> 3.14 자체를 double형으로 인식함.
		float f4= (float)3.14; //형 변환 후 대입 (권장사항 아님)
		System.out.println("f4="+ f4);
		
		float f5 = 3.14F; //자바에서는 접미사 사용을 권장하고 있음
		System.out.println("f5="+ f5);
		
		float f6 = f3 + f4; //float _ float = float
