...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		자동형변환 : 작은 상자의 데이터를 큰 사용자에 대입할 때 자동으로 
			형변환이 일어난다. 
		 */
		byte b1 = 65;
		short s1;
		...
		/*
		아래 코드는 자동형변환이 아님. CPU는 int보다 작은 자료형을 int로 간주하고 
		...
		/*
		 소수점 아래 부분이 버려지므로 데이터 손실됨. 
		 따라서 특수한 경우가 아니라면 사용을 자제하는 것이 좋다. 
		 */
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
		System.out.printf("데이터 손실:num3=%d, dl=%.2f %n", 
				num3, dl);
		
		/*
		 char와 int를 연산하면 결과는 int를 반환하므로 char형 변수에
		 대입하려면 명시적 형변환 후 해야 한다. 
		 */
		char ch3 = 'A', ch4;
		int num4 = 2;
