...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		주소값을 반환한다. 
		그래서 배열명(배열변수)를 주소값(참조값)을 할당받게 된다. 
		해당 주소를 통해 배열에 접근한다. 
		 */
		...
		initArr[0] = 100;
		System.out.println("initArr[0]=0" + initArr[0]);
